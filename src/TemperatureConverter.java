...
public class TemperatureConverter {
    public static void main (String[] args){
        ...
        Scanner sc = new Scanner(System.in); //정수를 입력받기위해 Scanner 클래스 활용
        ...
        System.out.printf("섭씨 온도 : %.3f",c_tem); // c_tem을 소수점 3자리까지만 표현해주기 위해 서식문자를 활용해준다. 그렇기 때문에 printf를 사용한다
    }
}
